...
describe "Javascript grammar", ->
  ...
  describe "comments", ->
    ...
    it "tokenizes Closure Compiler-style JSDoc comment documentation", ->
      {tokens} = grammar.tokenizeLine('/** @param {!Array<Map<{foo:*}, ?>>|string} variable this is the description */')
      expect(tokens[4]).toEqual value: '{!Array<Map<{foo:*}, ?>>|string}', scopes: ['source.js', 'comment.block.documentation.js', 'other.meta.jsdoc', 'entity.name.type.instance.jsdoc']
      expect(tokens[6]).toEqual value: 'variable', scopes: ['source.js', 'comment.block.documentation.js', 'other.meta.jsdoc', 'variable.other.jsdoc']
      expect(tokens[8]).toEqual value: 'this is the description ', scopes: ['source.js', 'comment.block.documentation.js', 'other.meta.jsdoc', 'other.description.jsdoc']
